...
class GasEquilibrium:
    ...
    def plot_conversions_yields(self):
        ...
        ax.set_title('Equilibrium Conversions-Yields-Ratios', fontsize=10)
        ax.set_ylabel('$Conversions$ $&$ $Yields$', fontsize=12, fontweight='bold')
        ax.set_xlabel('$Temperature$ $[^oC]$', fontsize=12, fontweight='bold')
        ax.grid(ls="-", alpha = 0.2)
        ax.legend()
        ax_b = ax.twinx()
        ax_b.plot(self.T_range-273.15, self.ratio_h2_co['H2/CO'], "k:", label = '$H_2$/$CO$', lw = 1)
        ax_b.set_ylabel('$H_2/CO$', fontsize=12, fontweight='bold')
    ...
    def plot_molar_ratio(self):
        ...
        ax.set_title('Equilibrium Compositions', fontsize=10)
